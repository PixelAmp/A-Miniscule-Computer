...
<drawing version="7">
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <text style="fontsize:32;fontname:Arial" x="836" y="200">Tick Out Turns on at 0 to increment the count</text>
        <text style="fontsize:32;fontname:Arial" x="836" y="120">Takes in 1hz and outputs 0-7</text>
        <text style="fontsize:32;fontname:Arial" x="796" y="2356">There may be a bug where the program counter gets immediatly incremented because it goes up on the zero</text>
        <text style="fontsize:32;fontname:Arial" x="720" y="2464">That way it still goes thought all 8 steps, but doesn't increment the program counter</text>
        <text style="fontsize:32;fontname:Arial" x="720" y="2416">I think that the way to get around this would be to include a latch in this file so that tickout only goes on after it goes around one time</text>
    </sheet>
</drawing>